...
export default function BadgeEarnedOverlay({ badge, explorerId, onClose }) {
  async function handleContinue() {
    ...
    // Refresh explorer data (Passport + Level)
  ...
  return (
    ...
    >
      ...
      >
        ...
        <h2 className="text-2xl font-bold mb-2 theme-text">Badge Earned!</h2>
